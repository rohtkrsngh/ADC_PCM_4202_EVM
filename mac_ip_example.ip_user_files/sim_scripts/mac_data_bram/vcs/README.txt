...
#
# Generated by export_simulation on Thu Feb 21 15:44:14 +0530 2019
#
################################################################################
...
switch to the './mac_data_bram.sh' script.

./mac_data_bram.sh -reset_run
...
./mac_data_bram.sh -noclean_files

For more information on the script, please type './mac_data_bram.sh -help'.
