...
#
# Generated by export_simulation on Thu Feb 21 16:13:26 +0530 2019
#
################################################################################
...
switch to the './fifo_ll.sh' script.

./fifo_ll.sh -reset_run
...
./fifo_ll.sh -noclean_files

For more information on the script, please type './fifo_ll.sh -help'.
