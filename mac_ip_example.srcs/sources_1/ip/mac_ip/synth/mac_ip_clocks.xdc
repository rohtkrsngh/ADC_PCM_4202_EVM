...
set_false_path -from [get_cells {mac_ip_core/*managen/conf/int_*reg[*]}] -to $ip_gtx_clk
set_false_path -from [get_cells {mac_ip_core/*managen/conf/int_*reg[*]}] -to $rx_clk
set_false_path -from [get_cells {mac_ip_core/*managen/conf/int_*reg}] -to $ip_gtx_clk
set_false_path -from [get_cells {mac_ip_core/*managen/conf/int_*reg}] -to $rx_clk
