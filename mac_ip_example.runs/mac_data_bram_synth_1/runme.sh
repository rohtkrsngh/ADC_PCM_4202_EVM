...
HD_PWD='i:/rgmii/viv16/mac_ip_example/mac_ip_example.runs/mac_data_bram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mac_data_bram.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mac_data_bram.tcl
