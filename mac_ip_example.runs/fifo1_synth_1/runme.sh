...
HD_PWD='i:/rgmii/viv16/mac_ip_example/mac_ip_example.runs/fifo1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo1.vds -m64 -mode batch -messageDb vivado.pb -notrace -source fifo1.tcl
