...
HD_PWD='i:/rgmii/viv16/mac_ip_example/mac_ip_example.runs/fifo_ll_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_ll.vds -m64 -mode batch -messageDb vivado.pb -notrace -source fifo_ll.tcl
