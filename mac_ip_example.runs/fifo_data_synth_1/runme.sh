...
HD_PWD='i:/rgmii/viv16/mac_ip_example/mac_ip_example.runs/fifo_data_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_data.vds -m64 -mode batch -messageDb vivado.pb -notrace -source fifo_data.tcl
